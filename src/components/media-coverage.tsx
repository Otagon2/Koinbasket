                ...
                >
                    {media.map((item, idx) => (
                        <motion.div
                            ...
                            className="bg-white rounded-3xl border border-slate-200/60 shadow-lg shadow-slate-200/40 hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-2 transition-all duration-300 cursor-pointer group"
                        >
                            <a href="https://www.koinbasket.com" className="p-8 block w-full h-full">
