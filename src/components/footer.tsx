        ...
        <footer className="bg-[#05160b] pt-24 pb-12 border-t border-white/5">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="bg-brand-dark rounded-3xl p-10 md:p-16 mb-20 relative overflow-hidden flex flex-col items-center text-center shadow-2xl shadow-brand-dark/50 border border-brand-lime/10">
                    ...
                    <a href="https://www.koinbasket.com" className="bg-brand-lime text-brand-dark text-lg font-bold px-10 py-5 rounded-full hover:bg-[#a5db38] hover:shadow-[0_0_30px_rgba(178,240,66,0.5)] transition-all duration-300 cursor-pointer flex items-center gap-3 group relative z-10 shadow-[0_0_15px_rgba(178,240,66,0.3)]">
                        Get started
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16 border-b border-white/10 pb-16">
                    ...
                    <div className="lg:col-span-3 flex flex-col items-center lg:items-start text-center lg:text-left">
                        <ul className="flex flex-col gap-4">
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">Company</a></li>
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">News Room</a></li>
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">Research Articles</a></li>
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">Careers</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-3 flex flex-col items-center lg:items-start text-center lg:text-left">
                        <ul className="flex flex-col gap-4">
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">Privacy policy</a></li>
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">Terms & conditions</a></li>
                            <li><a href="https://www.koinbasket.com" className="text-white/70 font-medium hover:text-brand-lime transition-colors">Disclaimer</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-8 items-center lg:items-start text-center lg:text-left">
                        <div className="flex flex-col items-center lg:items-start">
                            ...
                            <a href="https://www.koinbasket.com" className="text-white font-medium hover:text-brand-lime transition-colors word-break text-sm">Support@koinbasket.com</a>
                        </div>
                        <div className="flex flex-col items-center lg:items-start">
                            <h4 className="text-white/50 text-xs font-bold uppercase tracking-wider mb-4">Follow us</h4>
                            <div className="flex gap-3 justify-center lg:justify-start">
                                <a href="https://www.koinbasket.com" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:text-brand-dark hover:bg-brand-lime hover:border-brand-lime transition-all shadow-sm">
